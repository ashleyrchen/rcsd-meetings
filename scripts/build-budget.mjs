...
<section class="section" id="schools">
  ...
  <div class="table-wrap">
    <table>
      ...
      <tbody>
        <tr><td>Adelante Selby</td><td class="num">$854K</td><td class="num">$1,467</td><td class="num">$73K</td><td class="num">$289K</td><td class="num">$165K</td><td class="num">$147K</td><td class="num">$86K</td></tr>
        <tr><td>McKinley MIT</td><td class="num">$795K</td><td class="num">$1,656</td><td class="num">$27K</td><td class="num">$610K</td><td class="num">&mdash;</td><td class="num">$75K</td><td class="num">$77K</td></tr>
        <tr><td>Hoover</td><td class="num">$734K</td><td class="num">$1,073</td><td class="num">$128K</td><td class="num">&mdash;</td><td class="num">&mdash;</td><td class="num">$183K</td><td class="num">$116K</td></tr>
        <tr><td>Henry Ford</td><td class="num">$681K</td><td class="num">$1,523</td><td class="num">$61K</td><td class="num">$249K</td><td class="num">$75K</td><td class="num">$147K</td><td class="num">$75K</td></tr>
        <tr><td>Clifford</td><td class="num">$665K</td><td class="num">$951</td><td class="num">$73K</td><td class="num">$73K</td><td class="num">$196K</td><td class="num">$173K</td><td class="num">$93K</td></tr>
        <tr><td>North Star</td><td class="num">$564K</td><td class="num">$1,066</td><td class="num">&mdash;</td><td class="num">$10K</td><td class="num">$326K</td><td class="num">$135K</td><td class="num">$59K</td></tr>
        <tr><td>Kennedy</td><td class="num">$563K</td><td class="num">$694</td><td class="num">$76K</td><td class="num">$96K</td><td class="num">$20K</td><td class="num">$192K</td><td class="num">$117K</td></tr>
        <tr><td>Roy Cloud</td><td class="num">$415K</td><td class="num">$652</td><td class="num">&mdash;</td><td class="num">$234K</td><td class="num">$113K</td><td class="num">$59K</td><td class="num">&mdash;</td></tr>
        <tr><td>Garfield</td><td class="num">$243K</td><td class="num">$872</td><td class="num">$55K</td><td class="num">&mdash;</td><td class="num">$0</td><td class="num">$79K</td><td class="num">$90K</td></tr>
        <tr><td>Orion</td><td class="num">$235K</td><td class="num">$456</td><td class="num">&mdash;</td><td class="num">&mdash;</td><td class="num">$130K</td><td class="num">$73K</td><td class="num">$9K</td></tr>
        <tr><td>Roosevelt</td><td class="num">$223K</td><td class="num">$569</td><td class="num">$40K</td><td class="num">&mdash;</td><td class="num">&mdash;</td><td class="num">&mdash;</td><td class="num">$88K</td></tr>
        <tr><td>Taft</td><td class="num">$190K</td><td class="num">$521</td><td class="num">$42K</td><td class="num">&mdash;</td><td class="num">&mdash;</td><td class="num">$48K</td><td class="num">$72K</td></tr>
      </tbody>
    </table>
  </div>
  <p class="source">Source: 2025-26 School Plans for Student Achievement (SPSAs).</p>
...
<section class="section" id="escuelas">
  ...
  <p class="source">Fuente: Planes Escolares para el Logro Estudiantil (SPSAs) 2025-26.</p>
